    ...
    <header>
        ...
        <div class="inferior">
            <div class="menu">
                <nav>
                    <ul>
                        <li><a href="../php/ingreso_admin.php"><h4>inicio</h4></a></li>
                        <li><a href="../php/biblioteca_admin_admin.php"><h4>biblioteca</h4></a></li>
                        <li><a href="#"><h4>generos</h4></a>
                            <ul>
                                <li><a href="../php/biblioteca_admin.php #aventuras">
                                        <h4>aventuras</h4>
                                    </a></li>
                                <li><a href="../php/biblioteca_admin.php #misterios">
                                        <h4>misterios</h4>
                                    </a></li>
                                <li><a href="../php/biblioteca_admin.php #Romances">
                                        <h4>romances</h4>
                                    </a></li>
                            </ul>
                        </li>
