...
<body>
    ...
    <div class="contenido-principal">
        ...
        <div class="contenedor">
            ...
            <form id="nuevoLibroForm">
                ...
                <button type="button" onclick="agregarNuevoLibro()">Agregar Libro</button>
            </form>
        </div>

        <div class="contenedor">
            <h1>Sugerencias</h1>
            <p id="aventuras">"Sugerencia de Libros" es un espacio donde los usuarios comparten sus libros favoritos con breves descripciones, promoviendo el intercambio de recomendaciones literarias.</p>
            <div id="nuevoLibroDiv">
                <!-- Aquí se agregará el nuevo libro -->
            </div>
        ...
        <div class="contenedor">
            <div class="libro">
                ...
                <div class="informacion-libro">
                    ...
                    <p>as el largo verano, el invierno se acerca a los Siete Reinos. Lord Eddard Stark, señor de
        ...
        <div class="contenedor">
            <div class="libro">
                ...
                <div class="informacion-libro">
                    ...
                    <p>La audaz mezcla de realismo descarnado y de sentimientos románticos característica de Dashiell
                        ...
                        ha sido objeto, durante más de cuatro siglos, de robos y extravíos. Cuando tras mil peripecias
                        llega a la ciudad de San Francisco, un grupo de delincuentes trata de apoderarse de ella, lo que
                        ...
                        Lorre.
                        La audaz mezcla de realismo descarnado y de sentimientos románticos característica de Dashiell
                        Hammett (1894-1961) alcanza en "El halcón maltés" (1930) su mejor expresión. Una estatuilla con
                        figura de halcón que los caballeros de la Orden de Malta regalaron al emperador Carlos V en 1530
                        ha sido objeto, durante más de cuatro siglos, de robos y extravíos. Cuando tras mil peripecias
                        llega a la ciudad de San Francisco, un grupo de delincuentes trata de apoderarse de ella, lo que
        ...
        <div class="contenedor">
            <div class="libro">
                ...
                <div class="informacion-libro">
                    <h2>Spade & Archer</h2>
                    <p>Joe Gores es autor de dieciséis novelas por las que ha recibido múltiples premios, así como
                        ...
                        negra descubrirá cómo el protagonista de El Halcón Maltés, Sam Spade, se convirtió en lo que es.
                    </p>
                </div>
            </div>
            <div class="informacion-autor">
        ...
        <div class="contenedor">
            <div class="libro">
                ...
                <div class="informacion-libro">
                    <h2>Cosecha roja</h2>
                    <p>cuando en una pequeña ciudad minera la mortandad se multiplica por diez y los propios coches de
        ...
        <div class="contenedor">
            <div class="libro">
                ...
                <div class="informacion-libro">
                    ...
                    <p>Dos adolescentes, Stella y Will, se encuentran en un hospital debido a las graves enfermedades
        ...
        <div class="contenedor">
            <div class="libro">
                ...
                <div class="informacion-libro">
                    <h2>After</h2>
                    <p>Tessa Young acaba de llegar a la universidad, y su estable y ordenada vida da un giro busco al
    ...
    <script src="../js/Nuevos_Libros.js"></script>
